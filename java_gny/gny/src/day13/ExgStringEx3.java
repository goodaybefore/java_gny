...
public class ExgStringEx3 {
	...
	public static void main(String[] args) {
		 ...
		 *  - equals와 비슷
		 *  - equals는 두 문자열이 같은지(true) 다른지(false)만 알려줌
		 *  - compareTo는 두 문자열이 사전 순으로 어떻게 되는지 알려줌
		 *  -  같으면 0, 다르면 음수,양수 
		 *  - compareTo를 활용하면 문자열들을 사전순으로 정렬할 수 있습니다.
		 *  - A.compareTo(B) 했을 때
		 *    0 : A와 B는 같은 문자
		...
		System.out.println(str3+"는 "+str1+"보다 사전순으로?"+str3.compareTo(str1));
